...
The default WCS is called `G54`, but others are available via G55-G59.3. When using Carvera Community Firmware 1.0.9c+ together with v0.10.0+ of the Community Controller you can now easily change between the different WCS systems via the Top Bar, and advanced WCS management screens. Each WCS will store it's own offsets to EEPROM. Multiple WCS are useful for:
