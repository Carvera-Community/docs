...
This functionality is supported on Windows, Linux, and MacOS. It is not available for iOS or Android.
...
These can be configured in the Settings->Pendant screen by clicking the <img src="../../.gitbook/assets/image (3).png" alt="Open editor..." data-size="line">UI button corresponding to the Macro number.
