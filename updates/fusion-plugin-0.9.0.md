...
Please note that this is the first release of this plugin and there may be bugs. Please report issues via [GitHub issues](https://github.com/Carvera-Community/Carvera_Community_FusionPlugin/issues) or the community Discord channels linked in the [plugin docs](https://github.com/Carvera-Community/docs/blob/main/updates/fusion/plugin.md).
