...
* [Features](firmware/features/README.md)
  * [3D Probe Support](firmware/supported-commands/mcodes/probing/3d-probe-support.md)
  * [3D Probe Crash Protection](firmware/features/probe-crash-protection.md)
  ...
  * [Manual Tools](firmware/features/manual-tools.md)
  * [LED Behaviour](firmware/features/led-behavior.md)
  * [Playback Suspend and Resume](firmware/features/playback-suspend.md)
  * [4th Axis Feed Rate](firmware/features/rotary-a-feed-rate.md)
  * [Spindle maximum RPM](firmware/features/spindle-max-rpm.md)
  * [USB serial baud rate](firmware/features/usb-serial-baud-rate.md)
  * [Spindle Control Types](firmware/features/spindle-control-types/README.md)
    * [C1 Improved PID Spindle Control](firmware/features/spindle-control-types/c1-improved-pid-spindle-control.md)
    * [VESC USB Spindle](firmware/features/spindle-control-types/vesc-usb-spindle.md)
  * [Communication Protocol](firmware/features/communication-protocol.md)
  * [WiFi AP Auto-Disable](firmware/features/wifi-ap-auto-disable.md)
  * [Debug Mode](firmware/features/debug-mode.md)
  * [Hardware Health Checks](firmware/features/hardware-health-checks.md)
* [Supported Commands](firmware/supported-commands/README.md)
  ...
  * [MCodes](firmware/supported-commands/mcodes/README.md)
    ...
    * [Hardware Health Checks](firmware/supported-commands/mcodes/hardware-health-checks.md)
    * [Hard Endstops](firmware/supported-commands/mcodes/hard-endstops.md)
